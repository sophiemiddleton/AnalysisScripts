...
def compare_datasets( files, cuts, locations, columns, signs):
    ...
    #comparison.overlay_fit(100.47, 2.11, 14.45, 4.45, 1141, recomom, mc_count)
...
def  main(args):
  ...
  new_early = [True, True, False, True, True,False, True, False, False,False,True, True,True, True]
  ...
  columns = ["e+","e-"]
  compare_datasets(files, [new_early, new_early], locations, columns, signs)
